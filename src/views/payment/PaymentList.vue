    ...
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="username" label="訂單">
          <el-input v-model="searchData.keyword" placeholder="銷售發票號" style="width: 300px" />
        </el-form-item>
        <el-form-item>
          <el-date-picker
    ...
    <el-card v-loading="loading" shadow="never">
        ...
        <div class="flex justify-between">
          <div>
            <el-radio-group v-model="radio2">
              ...
              <el-radio-button label="客戶預付款" value="2" />
              <el-radio-button label="工廠預付款" value="3" />
            </el-radio-group>
          </div>
          <div>
            <el-text size="large">應收/應付金額：</el-text>
      ...
      <div class="table-wrapper">
        <el-table ref="tableRef" :data="tableData">
          ...
          <el-table-column prop="username" label="銷售發票" align="center" />
          <el-table-column prop="advance_payment" label="應收金額" align="center" />
          <el-table-column prop="advance_payment" label="實收金額" align="center" />
          <el-table-column prop="advance_payment" label="未收金額" align="center" />
          <el-table-column prop="advance_payment" label="應收狀態" align="center" />
          <el-table-column prop="created_at" label="创建时间" align="center" sortable />
          <el-table-column fixed="right" label="操作" width="200" align="center">
            <template #default="scope">
              <el-button type="primary" text bg size="small" @click="handleView(scope.row)">添加金額</el-button>
              <el-button type="danger" text bg size="small" @click="handleDelete(scope.row)">確認付款</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
