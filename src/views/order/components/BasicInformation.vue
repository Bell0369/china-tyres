  ...
  <div>
    <el-card shadow="never" class="search-wrapper">
      ...
      <el-descriptions :column="3" border>
        ...
        <el-descriptions-item label="訂單總數量">{{ orderInfo.order_number_sum }}</el-descriptions-item>
        <el-descriptions-item label="未生產數量">{{ orderInfo.unproduced }}</el-descriptions-item>
        <el-descriptions-item label="PI數量">{{ orderInfo.pi_number }}</el-descriptions-item>
        <el-descriptions-item label="PI已發貨數量">{{ orderInfo.pi_shipped }}</el-descriptions-item>
        <el-descriptions-item label="PI未發貨數">{{ orderInfo.pi_not_shipped }}</el-descriptions-item>
        <el-descriptions-item label="預計櫃量(40'HQ)">{{ orderInfo.quantity }}</el-descriptions-item>
